...
***REMOVED*** = "AKIAI76KB5WQP3434LHQ"
SECRET***REMOVED*** = "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"

ec2 = boto.ec2.connect_to_region("us-east-1", aws_access_key_id=***REMOVED***,aws_secret_access_key=SECRET***REMOVED***)
