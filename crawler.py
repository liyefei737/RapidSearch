...
class crawler(object):
    ...
    def save_to_db(self):
        ...
        if collection.find_one({"type": "inverted_index"}) is None:
            ...
            collection.replace_one({"type": "inverted_index"},
                                   {"type": "doc_index", "value": bson_formated_inverted_index})
        ...
        if collection.find_one({"type": "doc_id_to_url"}) is None:
            ...
            collection.replace_one({"type": "doc_id_to_url"},
                                   {"type": "doc_id_to_url", "value": bson_formatted_doc_id_to_url})
    ...
    def bson_format_inverted_index(inverted_index):
        formatted = {}
        for key in inverted_index:
            formatted[str(key)] = list(inverted_index[key])
        return formatted

    def bson_key_to_str(d):
